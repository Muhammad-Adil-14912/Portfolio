...
function initChatbot() {
  ...
  const responses = {
    ...
    'show resume': '<p>You can view his resume by clicking this link: <a href="resume.pdf" target="_blank" class="chatbot-link">View Resume (PDF)</a>. You can also download/view it in the Contact section.</p>',
